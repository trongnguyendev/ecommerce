            ...
            <div class="col-span-5 lg:col-span-4 p-2 lg:p-4">
                <div class="top-banner-product grid gap-3">
                    ...
                    <nav class="pagination justify-end" role="navigation" aria-label="pagination">
                        ...
                        <a href="#" class="pagination-link text-color-t" aria-label="Goto next page"><svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg></a>
                    </nav>
                    <!-- end pagination -->
                </div>
